<x-guest-layout>
    <div class="w-full max-w-[1400px] px-4 mx-auto">
        <div class="flex pb-4">
            <a href="{{ route('announcements') }}" class="px-6 py-2 rounded text-gray-800 bg-white hover:bg-gray-100 cursor-pointer">Back</a>
        </div>
