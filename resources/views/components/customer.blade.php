        ...
        <div class="flex items-center">
            <div class="flex items-center ms-3">
              <div class="flex items-center space-x-4">
                <a href="{{ route('services.type') }}" class="inline-flex items-center justify-center px-4 py-2.5 mr-3 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                    Request Service
              ...
              <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-user">
                <div class="px-4 py-3" role="none">
                  <p class="text-sm text-gray-900 dark:text-white" role="none">
                        {{ Auth::user()->profile->first_name ?? 'First Name'}} {{ Auth::user()->profile->last_name ?? 'Last Name'}}
                  </p>
  ...
  <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-24 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
     <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
           <li>
                <a href="{{ route('customer.requests') }}" class="flex items-center p-2  rounded-lg dark:text-white {{ Request::is('*requests*') ? 'bg-blue-50 text-blue-600' : 'text-gray-900'}} hover:bg-gray-100 dark:hover:bg-gray-700 group">
                <svg class="{{ Request::is('*requests*') ? 'text-blue-600' : 'text-gray-500'}} flex-shrink-0 w-5 h-5 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                    <path d="M14 2a3.963 3.963 0 0 0-1.4.267 6.439 6.439 0 0 1-1.331 6.638A4 4 0 1 0 14 2Zm1 9h-1.264A6.957 6.957 0 0 1 15 15v2a2.97 2.97 0 0 1-.184 1H19a1 1 0 0 0 1-1v-1a5.006 5.006 0 0 0-5-5ZM6.5 9a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9ZM8 10H5a5.006 5.006 0 0 0-5 5v2a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1v-2a5.006 5.006 0 0 0-5-5Z"/>
                </svg>
                <span class="flex-1 ms-3 whitespace-nowrap">My Request</span>
                </a>
            </li>

            <li>
                <a href="{{ route('profile.edit-user') }}" class="flex items-center p-2  rounded-lg dark:text-white {{ Request::is('*profile*') ? 'bg-blue-50 text-blue-600' : 'text-gray-900'}} hover:bg-gray-100 dark:hover:bg-gray-700 group">
...
<div class="min-h-screen h-auto p-4 sm:ml-64 ">
    {{ $slot }}
</div>
