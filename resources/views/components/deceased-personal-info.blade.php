<div class="flex flex-col space-y-4">
    ...
    <div class="w-full flex space-x-4 items-start">
        ...
        <div class="w-full flex flex-col">
            ...
            value="{{ old('middle_name') ?? ($deceased->middle_name ?? '') }}" />
            @error('middle_name')
                <span class="text-xs text-red-500 pl-2">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="w-full flex flex-col">
            ...
            <input type="text" name="last_name" placeholder="Last name" id="last_lame" class="focus:bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full px-4 py-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            value="{{ old('last_name') ?? ($deceased->last_lame ?? '') }}" />
            @error('last_name')
                <span class="text-xs text-red-500 pl-2">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="w-full flex space-x-4 items-start mb-4">
        ...
        <div class="w-full flex flex-col">
            ...
            <select name="sex" placeholder="Sex" id="sex" class="focus:bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <option value="" {{ (old('sex') ?? ($deceased->sex ?? '')) == '' ? 'selected' : '' }}>Sex</option>
    ...
    <div class="w-full flex space-x-4 items-start">
        ...
        <div class="w-full flex flex-col">
            ...
            value="{{ old('lot_block') ?? ($deceased->address->lot_block ?? '') }}" />
            @error('lot_block')
                <span class="text-xs text-red-500 pl-2">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="w-full flex flex-col">
            ...
            value="{{ old('street') ?? ($deceased->address->street ?? '') }}" />
            @error('street')
                <span class="text-xs text-red-500 pl-2">{{ $message }}</span>
            @enderror
        </div>
        <div class="w-full flex flex-col">
            ...
            value="{{ old('brgy') ?? ($deceased->address->brgy ?? '') }}" />
            @error('brgy')
                <span class="text-xs text-red-500 pl-2">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="w-full flex space-x-4 items-start">
        <div class="w-full flex flex-col">
            ...
            <input type="text" name="city" placeholder="City" id="city" class="focus:bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full px-4 py-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
             value="{{ old('city') ?? ($deceased->adress->city ?? '') }}" />
            @error('city')
                <span class="text-xs text-red-500 pl-2">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="w-full flex flex-col">
            ...
            value="{{ old('province') ?? ($deceased->address->province ?? '') }}" />
            @error('province')
                <span class="text-xs text-red-500 pl-2">{{ $message }}</span>
            @enderror
        </div>
