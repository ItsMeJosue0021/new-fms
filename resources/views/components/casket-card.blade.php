    ...
    <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
        ...
        <div class="p-4">
            ...
            <div class="flex items-center justify-between z-50">
                <a href="{{ route('services.caskets-select', ['serviceId' => $service->id, 'casket' => $casket->id]) }}" class="text-white text-sm px-4 py-2 rounded bg-blue-600 hover:bg-blue-700 flex items-center">Select and proceed
