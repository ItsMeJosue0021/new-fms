    ...
    <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
        ...
        <div class="p-4">
            ...
            <div class="flex items-center justify-between z-50">
                <a href="{{ route('services.caskets-select', ['serviceId' => $serviceId, 'casket' => $casket->id]) }}" class="text-indigo-500 inline-flex text-sm items-center md:mb-2 lg:mb-0">Select and proceed
