            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        ...
                        <li>
                            <a href="{{ route('caskets') }}" class="hover:underline">Caskets</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        ...
                        <li>
                            <a href="{{ route('announcements') }}" class="hover:underline">Announcements</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        ...
                        {{-- <li>
                            <a href="{{ route('home') }}" class="hover:underline">Terms &amp; Conditions</a>
                        </li> --}}
                    </ul>
                </div>
            </div>
