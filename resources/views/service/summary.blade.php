<x-guest-layout>
    <div>
        <div class="max-w-[1200px] px-4 mx-auto ">
            ...
            <div>
                <div class="pb-4">
                    <a href="{{ route('services.payment-terms', $service->id) }}" class="px-6 py-2 rounded text-gray-800 bg-gray-100 hover:bg-gray-300 cursor-pointer">Back</a>
                </div>
                ...
                <form action="{{ route('services.request-store', $service->id) }}" method="POST" class="mb-6 flex flex-col space-y-4">
                    ...
                    @else
                        <a href="{{ route('customer.requests') }}" class="px-6 text-sm py-2 rounded-md text-white bg-blue-700 hover:bg-blue-800 cursor-pointer text-center">Back to My Requests</a>
                    @endif
                </form>
            </div>
        </div>
