    ...
    <div>
        <div class="max-w-[1400px] mx-auto p-4 ">
            ...
            <div class="w-full flex flex-col items-center justify-center">
                ...
                <h2 class="text-7xl font-semibold text-blue-600 mb-4 text-center imperial-script-regular">Our Deepest Condolences</h2>
            ...
            {{-- <div class="pt-6 m-5 flex justify-center">
                <a class="text-2xl cursor-pointer  hover:bg-blue-800 bg-blue-700 text-white font-semibold py-4 px-8 rounded-md uppercase mt-2">
                    View your request
                </a>
            </div> --}}
        </div>
